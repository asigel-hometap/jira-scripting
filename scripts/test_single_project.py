#!/usr/bin/env python3
"""
Test script for single project cycle time calculation.

This script tests the enhanced weekly snapshot functionality with just one project.
"""
...
def test_single_project():
    """Test the enhanced weekly snapshot script with just one project."""
    print("🧪 Testing Single Project Cycle Time Calculation")
    print("=" * 60)
