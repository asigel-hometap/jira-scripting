#!/usr/bin/env python3
"""
Simple test script with cycle time calculations.
...
def fetch_5_projects():
    ...
    # Simple JQL query - just get 5 projects
...
def save_enhanced_csv(projects):
    ...
    csv_file = f'data/snapshots/processed/{timestamp}_enhanced_test.csv'
...
def main():
    """Main function."""
    print("🚀 Simple Jira Test with Cycle Times - 5 Projects Only")
    print("=" * 60)
